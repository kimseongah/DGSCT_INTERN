CUDA_VISIBLE_DEVICES=7 python3 main_trans.py --Adapter_downsample=8 --accum_itr=2 \
	...
	--model=MMIL_Net --num_conv_group=2 --num_tokens=32 --num_workers=16 --seed 43 --gpu=7 \

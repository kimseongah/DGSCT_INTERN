...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--init_epoch', type=int, default=5, metavar='LR',
							help='learning rate (default: 3e-4)')
		self.parser.add_argument(
			"--model", type=str, default='Prompted_MMIL_Net', help="with model to use")
		self.parser.add_argument(
			"--mode", type=str, default='train', help="with mode to use")
		self.parser.add_argument('--seed', type=int, default=1, metavar='S',
							help='random seed (default: 1)')
		self.parser.add_argument('--accum_itr', type=int)
		self.parser.add_argument('--log-interval', type=int, default=50, metavar='N',
							help='how many batches to wait before logging training status')
		self.parser.add_argument(
			"--model_save_dir", type=str, default='/workspace/DG-SCT/DG-SCT/AVE/models/checkpoint_swin/', help="model save dir")
		self.parser.add_argument(
			"--checkpoint", type=str, default='best',
			help="save model name")
		self.parser.add_argument(
			"--init_best", type=int, default='0',
			help="init_finetuned_model")
		self.parser.add_argument(
		...
		### for AV-ada ###
		self.parser.add_argument('--audio_folder', type=str, default="/workspace/data/AVE_Dataset/raw_audio", help="raw audio path")
		self.parser.add_argument('--video_folder', type=str, default="/workspace/data/DG_SCT/baidu/frames", help="video frame path")
		...
		self.parser.add_argument('--backbone_type', type=str, help="the backbone of htsat")
		
		self.parser.add_argument('--root_path', default="/workspace/DG-SCT", type=str)
